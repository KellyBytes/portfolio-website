  ...
  return (
    <div className="w-ful h-screen flex flex-col justify-center items-center isolate">
      ...
      <div className="flex flex-col md:items-center items-start xl:gap-y-10 gap-y-10 xl:mb-0 md:mb-20 mb-0">
        ...
        <button
          className="xl-[400px] md:w-[300px] w-[270px] bg-gray-900 dark:bg-gray-200 md:py-1 py-0 md:px-4 px-2 xl:text-2xl md:text-xl text-base text-white dark:text-gray-900 tracking-widest rounded-r-4xl flex justify-between items-center md:mr-auto md:ml-0 mx-auto"
        ...
        <div className="flex md:gap-12 gap-2 mr-auto">
          {socialIcons.map((social, index) => (
            <a
              href="#"
              key={index}
              className="xl:text-3xl md:text-2xl text-red-500 dark:text-yellow-500 hover:text-gray-900 dark:hover:text-white transition-colors duration-500"
            >
